...
int MC6809Exec(int CycleFor)
{
  ...
  while (CycleCounter < CycleFor) {
    ...
    case TST_D: //D
      temp8 = MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(temp8);
      cc[N] = NTEST8(temp8);
      cc[V] = 0;
      CycleCounter += 6;
    ...
    case CLR_D:	//F
      MemWrite8(0, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = 1;
      cc[N] = 0;
      cc[V] = 0;
      cc[C] = 0;
    ...
    case Page2:
      ...
      case LDY_D: //109E
        y.Reg = MemRead16((dp.Reg | MemRead8(PC_REG++)));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        CycleCounter += 6;
      ...
      case STY_D: //109F
        MemWrite16(y.Reg, (dp.Reg | MemRead8(PC_REG++)));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        CycleCounter += 6;
      ...
      case LDY_X: //10AE
        y.Reg = MemRead16(CalculateEA(MemRead8(PC_REG++)));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        CycleCounter += 6;
      ...
      case STY_X: //10AF
        MemWrite16(y.Reg, CalculateEA(MemRead8(PC_REG++)));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        CycleCounter += 6;
      ...
      case LDY_E: //10BE
        y.Reg = MemRead16(MemRead16(PC_REG));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        PC_REG += 2;
      ...
      case STY_E: //10BF
        MemWrite16(y.Reg, MemRead16(PC_REG));
        cc[Z] = ZTEST(y.Reg);
        cc[N] = NTEST16(y.Reg);
        cc[V] = 0;
        PC_REG += 2;
    ...
    case LEAX_X: //30
      x.Reg = CalculateEA(MemRead8(PC_REG++));
      cc[Z] = ZTEST(x.Reg);
      CycleCounter += 4;
      break;

    case LEAY_X: //31
      y.Reg = CalculateEA(MemRead8(PC_REG++));
      cc[Z] = ZTEST(y.Reg);
      CycleCounter += 4;
      break;
    ...
    case LEAU_X: //33
      u.Reg = CalculateEA(MemRead8(PC_REG++));
      CycleCounter += 4;
      break;
    ...
    case SUBA_D: //90
      postbyte = MemRead8((dp.Reg | MemRead8(PC_REG++)));
      temp16 = A_REG - postbyte;
      cc[C] = (temp16 & 0x100) >> 8;
      cc[V] = OTEST8(cc[C], postbyte, temp16, A_REG);
      A_REG = (temp16 & 0xFF);
    ...
    case SUBD_D: //93
      temp16 = MemRead16((dp.Reg | MemRead8(PC_REG++)));
      temp32 = D_REG - temp16;
      cc[C] = (temp32 & 0x10000) >> 16;
      cc[V] = OTEST16(cc[C], temp32, temp16, D_REG);
      D_REG = (temp32 & 0xFFFF);
    ...
    case ANDA_D: //94
      A_REG = A_REG & MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[N] = NTEST8(A_REG);
      cc[Z] = ZTEST(A_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case BITA_D: //95
      temp8 = A_REG & MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[N] = NTEST8(temp8);
      cc[Z] = ZTEST(temp8);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case LDA_D: //96
      A_REG = MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(A_REG);
      cc[N] = NTEST8(A_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case STA_D: //97
      MemWrite8(A_REG, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(A_REG);
      cc[N] = NTEST8(A_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case LDX_D: //9E
      x.Reg = MemRead16((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case STX_D: //9F
      MemWrite16(x.Reg, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case LDX_X: //AE
      x.Reg = MemRead16(CalculateEA(MemRead8(PC_REG++)));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case STX_X: //AF
      MemWrite16(x.Reg, CalculateEA(MemRead8(PC_REG++)));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case LDX_E: //BE
      x.Reg = MemRead16(MemRead16(PC_REG));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      PC_REG +=2;
    ...
    case STX_E: //BF
      MemWrite16(x.Reg, MemRead16(PC_REG));
      cc[Z] = ZTEST(x.Reg);
      cc[N] = NTEST16(x.Reg);
      cc[V] = 0;
      PC_REG +=2;
    ...
    case ANDB_D: //D4 
      B_REG = B_REG & MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[N] = NTEST8(B_REG);
      cc[Z] = ZTEST(B_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case BITB_D: //D5
      temp8 = B_REG & MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[N] = NTEST8(temp8);
      cc[Z] = ZTEST(temp8);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case LDB_D: //D6
      B_REG = MemRead8((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(B_REG);
      cc[N] = NTEST8(B_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case	STB_D: //D7
      MemWrite8(B_REG, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(B_REG);
      cc[N] = NTEST8(B_REG);
      cc[V] = 0;
      CycleCounter += 4;
    ...
    case LDD_D: //DC
      D_REG = MemRead16((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(D_REG);
      cc[N] = NTEST16(D_REG);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case STD_D: //DD
      MemWrite16(D_REG, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(D_REG);
      cc[N] = NTEST16(D_REG);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case LDU_D: //DE
      u.Reg = MemRead16((dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case STU_D: //DF
      MemWrite16(u.Reg, (dp.Reg | MemRead8(PC_REG++)));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case LDU_X: //EE
      u.Reg = MemRead16(CalculateEA(MemRead8(PC_REG++)));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case STU_X: //EF
      MemWrite16(u.Reg, CalculateEA(MemRead8(PC_REG++)));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      CycleCounter += 5;
    ...
    case LDU_E: //FE
      u.Reg = MemRead16(MemRead16(PC_REG));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      PC_REG +=2;
    ...
    case STU_E: //FF
      MemWrite16(u.Reg, MemRead16(PC_REG));
      cc[Z] = ZTEST(u.Reg);
      cc[N] = NTEST16(u.Reg);
      cc[V] = 0;
      PC_REG +=2;
...
static unsigned short CalculateEA(unsigned char postbyte)
{
  ...
  if (postbyte & 0x80)
  {
    ...
    case 9:
      ea = (*xfreg16[Register]) + MemRead16(PC_REG);
      CycleCounter += 4;
      PC_REG +=2;
      break;
