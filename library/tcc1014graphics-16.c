...
extern "C" {
  __declspec(dllexport)
    void __cdecl UpdateScreen16(SystemState* systemState)
  {
    ...
    if ((gs->HorzCenter != 0) && (gs->BoarderChange > 0))
      ...
      {
        systemState->PTRsurface16[x + (((systemState->LineCounter + gs->VertCenter) * 2) * (systemState->SurfacePitch))] = gs->BoarderColor16;

        if (!systemState->ScanLines)
          systemState->PTRsurface16[x + (((systemState->LineCounter + gs->VertCenter) * 2 + 1) * (systemState->SurfacePitch))] = gs->BoarderColor16;

        systemState->PTRsurface16[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((systemState->LineCounter + gs->VertCenter) * 2) * (systemState->SurfacePitch))] = gs->BoarderColor16;

        if (!systemState->ScanLines)
          systemState->PTRsurface16[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((systemState->LineCounter + gs->VertCenter) * 2 + 1) * (systemState->SurfacePitch))] = gs->BoarderColor16;
      }
    ...
    yStride = (((systemState->LineCounter + gs->VertCenter) * 2) * systemState->SurfacePitch) + (gs->HorzCenter * 1) - 1;
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=1
      {
        ...
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 7)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 6)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 5)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 4)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 3)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 2)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 1)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & WidePixel];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 15)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 14)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 13)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 12)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 11)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 10)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 9)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[1 & (WidePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 6)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 4)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 2)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & WidePixel];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 14)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 12)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 10)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[3 & (WidePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 4)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[15 & WidePixel];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 12)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[15 & (WidePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 7))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 6))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 5))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 4))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 3))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 2))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 1))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & WidePixel)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 15))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 14))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 13))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 12))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 11))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 10))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 9))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (1 & (WidePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7; bit >= 0; bit--)
          {
            ...
            case 3:
              color = 3;
              systemState->PTRsurface16[yStride - 1] = gs->Afacts16[gs->ColorInvert][3];

              if (!systemState->ScanLines) {
                systemState->PTRsurface16[yStride + systemState->SurfacePitch - 1] = gs->Afacts16[gs->ColorInvert][3];
              }

              systemState->PTRsurface16[yStride] = gs->Afacts16[gs->ColorInvert][3];

              if (!systemState->ScanLines) {
                systemState->PTRsurface16[yStride + systemState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][3];
              }
            ...
            systemState->PTRsurface16[yStride += 1] = gs->Afacts16[gs->ColorInvert][color];

            if (!systemState->ScanLines) {
              systemState->PTRsurface16[yStride + systemState->SurfacePitch] = gs->Afacts16[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 6))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 4))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 2))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & WidePixel)];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 14))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 12))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 10))];
        systemState->PTRsurface16[yStride += 1] = gs->Pallete16Bit[gs->PalleteIndex + (3 & (WidePixel >> 8))];
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawTopBoarder16(SystemState* systemState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    {
      systemState->PTRsurface16[x + ((systemState->LineCounter * 2) * systemState->SurfacePitch)] = gs->BoarderColor16;

      if (!systemState->ScanLines) {
        systemState->PTRsurface16[x + ((systemState->LineCounter * 2 + 1) * systemState->SurfacePitch)] = gs->BoarderColor16;
      }
    }
  }
}
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawBottomBoarder16(SystemState* systemState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    for (unsigned short x = 0; x < systemState->WindowSize.x; x++)
    {
      systemState->PTRsurface16[x + (2 * (systemState->LineCounter + gs->LinesperScreen + gs->VertCenter) * systemState->SurfacePitch)] = gs->BoarderColor16;

      if (!systemState->ScanLines) {
        systemState->PTRsurface16[x + systemState->SurfacePitch + (2 * (systemState->LineCounter + gs->LinesperScreen + gs->VertCenter) * systemState->SurfacePitch)] = gs->BoarderColor16;
      }
    }
  }
}