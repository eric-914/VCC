...
extern "C" {
  __declspec(dllexport)
    void __cdecl UpdateScreen8(SystemState* systemState)
  {
    ...
    if ((gs->HorzCenter != 0) && (gs->BoarderChange > 0)) {
      ...
      {
        systemState->PTRsurface8[x + (((systemState->LineCounter + gs->VertCenter) * 2) * systemState->SurfacePitch)] = gs->BoarderColor8;

        if (!systemState->ScanLines) {
          systemState->PTRsurface8[x + (((systemState->LineCounter + gs->VertCenter) * 2 + 1) * systemState->SurfacePitch)] = gs->BoarderColor8;
        }

        systemState->PTRsurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((systemState->LineCounter + gs->VertCenter) * 2) * systemState->SurfacePitch)] = gs->BoarderColor8;

        if (!systemState->ScanLines) {
          systemState->PTRsurface8[x + (gs->PixelsperLine * (gs->Stretch + 1)) + gs->HorzCenter + (((systemState->LineCounter + gs->VertCenter) * 2 + 1) * systemState->SurfacePitch)] = gs->BoarderColor8;
        }
      }
    }
    ...
    if (!systemState->LineCounter)
    {
      ...
      gs->TagY = systemState->LineCounter;
    }

    unsigned int start = gs->StartofVidram + (gs->TagY / gs->LinesperRow) * (gs->VPitch * gs->ExtendedText);
    yStride = (((systemState->LineCounter + gs->VertCenter) * 2) * systemState->SurfacePitch) + (gs->HorzCenter) - 1;
    ...
    case 0: //Width 80
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow * gs->ExtendedText; beam += gs->ExtendedText)
      {
        ...
        pixel = cc3Fontdata8x12[character * 12 + (systemState->LineCounter % gs->LinesperRow)];

        if (gs->ExtendedText == 2)
        {
          attributes = buffer[start + (unsigned char)(beam + gs->Hoffset) + 1];

          if ((attributes & 64) && (systemState->LineCounter % gs->LinesperRow == (gs->LinesperRow - 1))) { //UnderLine
            pixel = 255;
          }
        ...
        TextPallete[1] = gs->Pallete8Bit[8 + ((attributes & 56) >> 3)];
        TextPallete[0] = gs->Pallete8Bit[attributes & 7];
    ...
    case 127:
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam++)
      {
        ...
        case 0:
          ...
          TextPallete[0] = gs->Pallete8Bit[gs->TextBGPallete];
          TextPallete[1] = gs->Pallete8Bit[gs->TextFGPallete];
        ...
        case 2:
        case 3:
          TextPallete[1] = gs->Pallete8Bit[(character & 112) >> 4];
          TextPallete[0] = gs->Pallete8Bit[8];
    ...
    case 128 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 7)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 6)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 5)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 4)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 3)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 2)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 1)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & WidePixel];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 15)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 14)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 13)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 12)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 11)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 10)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 9)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[1 & (WidePixel >> 8)];
    ...
    case 128 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 6)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 4)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 2)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & WidePixel];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 14)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 12)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 10)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[3 & (WidePixel >> 8)];
    ...
    case 128 + 32: //Bpp=2 Sr=0 4BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 4)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & WidePixel];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 12)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[15 & (WidePixel >> 8)];
    ...
    case 192 + 0: //Bpp=0 Sr=0 1BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 7))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 6))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 5))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 4))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 3))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 2))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 1))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & WidePixel)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 15))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 14))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 13))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 12))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 11))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 10))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 9))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (1 & (WidePixel >> 8))];
      ...
      for (unsigned short beam = 0; beam < gs->BytesperRow; beam += 2) //1bbp Stretch=2
      {
        ...
        { //Pcolor
          for (bit = 7;bit >= 0;bit--)
          {
            ...
            case 3:
              color = 3;
              systemState->PTRsurface8[yStride - 1] = gs->Afacts8[gs->ColorInvert][3];

              if (!systemState->ScanLines) {
                systemState->PTRsurface8[yStride + systemState->SurfacePitch - 1] = gs->Afacts8[gs->ColorInvert][3];
              }

              systemState->PTRsurface8[yStride] = gs->Afacts8[gs->ColorInvert][3];

              if (!systemState->ScanLines) {
                systemState->PTRsurface8[yStride + systemState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][3];
              }
            ...
            systemState->PTRsurface8[yStride += 1] = gs->Afacts8[gs->ColorInvert][color];

            if (!systemState->ScanLines) {
              systemState->PTRsurface8[yStride + systemState->SurfacePitch] = gs->Afacts8[gs->ColorInvert][color];
            }
    ...
    case 192 + 16: //BPP=1 Sr=0  2BPP Stretch=1
      ...
      {
        WidePixel = systemState->WRamBuffer[(gs->VidMask & (start + (unsigned char)(gs->Hoffset + beam))) >> 1];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 6))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 4))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 2))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & WidePixel)];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 14))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 12))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 10))];
        systemState->PTRsurface8[yStride += 1] = gs->Pallete8Bit[gs->PalleteIndex + (3 & (WidePixel >> 8))];
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawTopBoarder8(SystemState* systemState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    {
      systemState->PTRsurface8[x + ((systemState->LineCounter * 2) * systemState->SurfacePitch)] = gs->BoarderColor8 | 128;

      if (!systemState->ScanLines) {
        systemState->PTRsurface8[x + ((systemState->LineCounter * 2 + 1) * systemState->SurfacePitch)] = gs->BoarderColor8 | 128;
      }
    }
  }
}
...
extern "C" {
  __declspec(dllexport)
    void __cdecl DrawBottomBoarder8(SystemState* systemState)
  {
    GraphicsState* gs = GetGraphicsState();
    ...
    for (unsigned short x = 0; x < systemState->WindowSize.x; x++)
    {
      systemState->PTRsurface8[x + (2 * (systemState->LineCounter + gs->LinesperScreen + gs->VertCenter) * systemState->SurfacePitch)] = gs->BoarderColor8 | 128;

      if (!systemState->ScanLines) {
        systemState->PTRsurface8[x + systemState->SurfacePitch + (2 * (systemState->LineCounter + gs->LinesperScreen + gs->VertCenter) * systemState->SurfacePitch)] = gs->BoarderColor8 | 128;
      }
    }
  }
}