...
extern "C" {
  __declspec(dllexport) void __cdecl AppStartup(HINSTANCE hInstance, PSTR lpCmdLine, INT nCmdShow) {
...
extern "C" {
  __declspec(dllexport) void __cdecl AppRun() {
    VccState* vccState = GetVccState();
...
extern "C" {
  __declspec(dllexport) INT __cdecl AppShutdown() {
    VccState* vccState = GetVccState();
...
extern "C" {
  __declspec(dllexport) INT __cdecl AppExec(HINSTANCE hInstance, PSTR lpCmdLine, INT nCmdShow) {
